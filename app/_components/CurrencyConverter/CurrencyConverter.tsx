    ...
    <div className="flex flex-col items-center justify-center my-5">
      ...
      <div className="flex mt-5">
        <input
          ...
          type="number"
          className="mb-6 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-l-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 cursor-not-allowed dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
        ></input>
        <select
          value={toCurrency}
      ...
      <div className="mt-5 text-xs sm:text-sm text-slate-300">
